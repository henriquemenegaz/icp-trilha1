...
import { idlFactory } from './login_frontend.did.js';
export { idlFactory } from './login_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LOGIN_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./login_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the login_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./login_frontend.did.js")._SERVICE>}
 */
export const login_frontend = createActor(canisterId);
