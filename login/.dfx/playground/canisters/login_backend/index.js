...
import { idlFactory } from './login_backend.did.js';
export { idlFactory } from './login_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LOGIN_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./login_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the login_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./login_backend.did.js")._SERVICE>}
 */
export const login_backend = createActor(canisterId);
