...
import { idlFactory } from './p1_to_do_frontend.did.js';
export { idlFactory } from './p1_to_do_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_P1_TO_DO_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./p1_to_do_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the p1_to_do_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./p1_to_do_frontend.did.js")._SERVICE>}
 */
export const p1_to_do_frontend = createActor(canisterId);
