...
import { idlFactory } from './exercicio2_frontend.did.js';
export { idlFactory } from './exercicio2_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_EXERCICIO2_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./exercicio2_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the exercicio2_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./exercicio2_frontend.did.js")._SERVICE>}
 */
export const exercicio2_frontend = createActor(canisterId);
