...
import { idlFactory } from './exercicio2_backend.did.js';
export { idlFactory } from './exercicio2_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_EXERCICIO2_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./exercicio2_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the exercicio2_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./exercicio2_backend.did.js")._SERVICE>}
 */
export const exercicio2_backend = createActor(canisterId);
